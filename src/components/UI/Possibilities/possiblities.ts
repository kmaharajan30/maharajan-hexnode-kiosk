export const possibilties = [
  {
    ...
    link: "ansn",
    imgSrc: "/images/possibilities/effortlessKiosk.webp",
  },
  {
    id: 2,
    details:
    ...
    link: "ansn",
    imgSrc: "/images/possibilities/customisedKiosk.webp",
  ...
  },
  {
    ...
    link: "ansn",
    imgSrc: "/images/possibilities/hexnodeKiosk.webp",
    label: "Data Security",
  },
  {
    id: 4,
    ...
    link: "ansn",
    imgSrc: "/images/possibilities/secureKiosk.webp",
  ...
  },
  {
    ...
    link: "ansn",
    imgSrc: "/images/possibilities/interfaceKiosk.webp",
    label: "Easy to use interface",
  },
];

export const buttonContexts = [
  { id: 1, text: "Effortless kiosk deployment & management" },
  { id: 2, text: "Customized interface for brand visibility" },
  { id: 3, text: "What more can you do with Hexnode kiosk?" },
  { id: 4, text: "Secure and update your app ecosystem" },
  { id: 5, text: "Provide an easy-to-use interface for end-users" },
];
