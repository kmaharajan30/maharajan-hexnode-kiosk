export const content = [
  ...
  },
  {
    ...
    subContent: [
      ...
      {
        id: 3,
        description: "Tailor your experience to match your unique use case.",
      },
      {
        id: 4,
        description:
...
export const buttonContexts = [
  { id: 1, text: "Single App Kiosk" },
  { id: 2, text: "Multi App Kiosk" },
  { id: 3, text: "Web-based Kiosk" },
  { id: 4, text: "Digital Signages" },
  { id: 5, text: "ASAM Kiosk" },
];
